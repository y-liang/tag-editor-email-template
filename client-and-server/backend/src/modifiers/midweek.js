...
import { ABSOLUTE_UNLOAD_PATH, MIDWEEK_FILE_PATH } from '../utils/constant.js';
...
const modifier = ({ sourcePath, targetPath, footerPath }) => {
    ...
    $tgt$('img').filter((i, el) => {
        // this === el
        return el.attribs.src === 'https://t.contentsvr.com/1980181091214740259550/viewInventory.gif';
    }).each((i, el) => {
    ...
    fs.writeFileSync(ABSOLUTE_UNLOAD_PATH + MIDWEEK_FILE_PATH, $tgt$.html());
};

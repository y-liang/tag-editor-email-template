...
import { NEWSLETTER_FILE_PATH, WEST_FIELDS, EAST_FIELDS, WORD_WEST, ABSOLUTE_UNLOAD_PATH } from '../utils/constant.js';
...
const modifier = ({ type, otherFilePath, fields }) => {
    ...
    fs.writeFileSync(ABSOLUTE_UNLOAD_PATH + NEWSLETTER_FILE_PATH, $tpl$.html());
};
